...
2. **Formularzustellung – konkreter Blocker:** Der Live-Test hat die ausstehende FormSubmit-Aktivierung nachgewiesen. Im Postfach `garage.asani@gmx.ch` muss die von FormSubmit angekündigte Aktivierungsmail geöffnet und deren „Activate Form“-Link für die richtige Website bestätigt werden; gegebenenfalls Spam prüfen. Anschliessend einen eindeutig gekennzeichneten Test wiederholen und den tatsächlichen Eingang sowie den Rücksprung zur Bestätigungsseite prüfen. Es gibt derzeit keinen bestätigten Zugriff auf das GMX-Postfach. Die ausdrückliche Freigabe für diesen Funktionstest liegt vor; keine erneute Freigabe für denselben Testablauf erforderlich.
