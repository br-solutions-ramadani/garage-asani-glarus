...
- Release `20260918-7`: Eigene Seite `agb.html` mit Bedingungen für Website und unverbindliche Anfragen, ohne erfundene Werkstatt-Vertragsbedingungen. Impressum und Datenschutzerklärung erklären jetzt den Datenfluss Browser → Cloudflare beziehungsweise Formular → FormSubmit → GMX, einschliesslich IP-Verarbeitung, Sicherheitsprotokollen, Formulararchiv und getrenntem E-Mail-Bestand. Die nicht bestätigten FormSubmit-Verarbeitungsstaaten und Vertragsgarantien werden ausdrücklich genannt. Keine pauschale Einwilligung, kein Rechteverzicht und keine Sicherheitsgarantie behauptet. Rechtstexte von allen HTML-Seiten erreichbar; alle acht Formulare nennen die Übermittlung technischer Verbindungsdaten einschliesslich IP-Adresse an FormSubmit.
...
- Die geänderten JavaScript-/CSS-Dateien werden mit einer neuen Versionskennung referenziert; Release-Kennung `20260918-6`. JavaScript-Syntaxprüfung und die vier Worker-Tests erfolgreich. Cloudflare-Build für Commit `bcc86a93ff3a1765647a9c0a6f8b6da7e5f0315a` erfolgreich; neue Datenschutztexte, Cookie-Detail-Link und Kontaktalternativen auf Hauptdomain und Leistungsseite im Browser bestätigt.
...
- Nach ausdrücklicher Aufforderung, mit der zuvor konkret beschriebenen Testanfrage fortzufahren, wurde am 18. September 2026 genau eine als Techniktest gekennzeichnete Anfrage über die Live-Seite `/leistungen/service-wartung/` an den konfigurierten FormSubmit-Endpunkt abgesendet. Sie enthielt keine Kundendaten. Die Antwortseite zeigte **„Check Your Email“** und **„This form needs Activation“**. FormSubmit meldet, eine Aktivierungsmail mit „Activate Form“-Link verschickt zu haben. Das belegt eine noch ausstehende Aktivierung, nicht den Eingang einer Kundenanfrage im GMX-Postfach. Keine weiteren Testsendungen ausgelöst.
...
| 2 | Nutzungsbedingungen | Eigene AGB-/Nutzungsbedingungen-Seite für Website und Anfragen, überall verlinkt. Werkstattauftrag erst nach individueller Vereinbarung; keine erfundenen Reparatur-, Zahlungs- oder Rückerstattungsbedingungen. |
...
2. **Formularzustellung – Eingang noch nicht bestätigt:** Der erste Live-Test zeigte eine Aktivierungsaufforderung von FormSubmit. Der Nutzer teilte anschliessend mit: „Ist schon aktiviert“. Dies ist als Nutzerbestätigung der Aktivierung dokumentiert; ein erneuter Ende-zu-Ende-Test und der Eingang im GMX-Postfach sind noch nicht unabhängig nachgewiesen. Es gibt keinen bestätigten Zugriff auf das GMX-Postfach. Die ausdrückliche Freigabe für denselben zuvor beschriebenen Techniktest liegt vor; keine erneute Freigabe für diesen Testablauf erforderlich.
